...
if (is.text) {
  cat (readr::read_lines(file = paste0(here::here(), '/', knitr::opts_current$get(name='left_content_path'))), sep = '\n')
} else {
  cat(knitr::knit_child(paste0(here::here(), '/', knitr::opts_current$get (name='left_content_path')),
                    options=list (name=knitr::opts_current$get (name='img_content_path'))), sep = '')
}
```
...
```{r, results='asis', echo=FALSE, out.width='100%'}
cat(knitr::knit_child(paste0(here::here(), '/', knitr::opts_current$get (name='right_content_path')),
                  options=list (name=knitr::opts_current$get (name='img_content_path'))), sep = '')
```
